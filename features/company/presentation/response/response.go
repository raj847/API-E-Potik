...
type CompanyRegisterRespone struct {
...
func FromDomainRegister(domain company.Domain) CompanyRegisterRespone {
	return CompanyRegisterRespone{
...
func FromDomainLogin(domain company.Domain) CompanyLoginResponse {
