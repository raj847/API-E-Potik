...
func (_m *Service) GetAllCustomerTrans(customerID int) ([]transactions.Domain, error) {
...
func (_m *Service) Trans(customerID int, domain *transactions.Domain) (transactions.Domain, error) {
